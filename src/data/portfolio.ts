export const portfolioData = {
  ...
  projects: [
    ...
    {
      id: "p15",
      title: "Callbridge AI Analytics Dashboard",
      role: "Product Designer",
      period: "2025.11 ~ 2026.03",
      company: "블룸에이아이",
      platform: "Web SaaS",
      users: "상담 운영자, 관리자",
      summary: "상담 데이터를 기록하는 것을 넘어, AI가 상담 주제와 반복 이슈를 분석해 운영 인사이트를 보여주는 대시보드를 만들었습니다.",
      tags: ["AI 분석", "운영 인사이트", "데이터 시각화"],
      problem: "상담 데이터가 쌓이기만 하고, 어떤 주제가 반복되는지·어디에 운영 리스크가 있는지 한눈에 보기 어려웠습니다.",
      strategy: "AI가 상담 주제·반복 이슈를 분석한 결과를 운영 리스크와 개선 포인트 중심으로 정리해, 데이터를 보고 판단할 수 있는 대시보드로 구성했습니다.",
      ownership: "기록 중심이던 화면을, 운영자가 데이터를 보고 다음 판단을 내릴 수 있는 분석 대시보드로 정리했습니다.",
      images: [],
    },
    {
      id: "p01",
