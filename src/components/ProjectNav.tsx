    ...
    >
      <div className="max-w-[720px] mx-auto px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3 overflow-hidden">
          <span className="font-semibold text-[color:#1d1d1f] truncate text-sm">
            {activeProject ? activeProject.title : "Projects"}
          </span>
        </div>
        <a 
          href="#" 
          className="text-xs font-medium text-[color:rgba(0,0,0,0.4)] hover:text-[color:#1d1d1f] whitespace-nowrap transition-colors"
          onClick={(e) => {
            e.preventDefault();
