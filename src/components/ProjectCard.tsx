...
export default function ProjectCard({ project, index }: ProjectCardProps) {
  ...
  return (
    ...
    >
      <Card className="relative h-full justify-center overflow-hidden rounded-xl bg-white ring-1 ring-zinc-200 shadow-[0px_8px_24px_0px_rgba(51,51,77,0.06)] transition-all duration-300 group-hover:-translate-y-0.5 group-hover:shadow-[0px_16px_36px_0px_rgba(51,51,77,0.12)] group-hover:ring-zinc-300">
